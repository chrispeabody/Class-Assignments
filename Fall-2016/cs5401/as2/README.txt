Sokoban Iterative-Deepening Depth First Tree Search Solver!
...
Alternatively you can leave off the [puzzlepath] arguement, in which case you will have to enter it in the program. Currently there is no support which validates that the size of the puzzle is the same as what is specified, no is there any support to make sure the number of crates matches the number of target positions. However, this functionality should be added soon.
